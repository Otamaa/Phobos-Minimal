...
void Phobos::Config::Read()
{
	...
	Phobos::Config::SuperWeaponSidebar_RequiredSignificance = pRA2MD->ReadBool(PHOBOS_STR, "SuperWeaponSidebar.RequiredSignificance", Phobos::Config::SuperWeaponSidebar_RequiredSignificance);
