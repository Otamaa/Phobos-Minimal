...
DEFINE_HOOK(0x72929D, TunnelLocomotionClass_7291F0_Speed, 0x8) //6
{
	...
	R->EAX(int(64.0 / pType->ROT / TechnoTypeExtData::GetTunnelSpeed(pLinkedTo, RulesClass::Instance)));
	return 0x7292BF;
}
...
DEFINE_HOOK(0x72951C, TunnelLocomotionClass_7294E0_Speed, 0x8)
{
	...
	R->EAX(int((nCurrentMovementSpeed) * TechnoTypeExtData::GetTunnelSpeed(pLoco->LinkedTo , pRules)));
	return 0x72952C;
}
