...
ASMJIT_PATCH(0x6E3EE0, TActionClass_GetFlags, 5)
{
	...
	std::pair<TriggerAttachType, bool> _result = TActionExtData::GetTriggetAttach(nAction);
...
ASMJIT_PATCH(0x6E3B60, TActionClass_GetMode, 8)
{
	...
	std::pair<LogicNeedType, bool> _result = TActionExtData::GetLogicNeed(nAction);
