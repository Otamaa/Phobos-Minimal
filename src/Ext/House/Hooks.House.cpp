...
ASMJIT_PATCH(0x4E3560, Game_GetFlagSurface, 5)
{
	...
	{
		//rani.pcx
		R->EAX(PCXImages::Instance->GetSurface(reinterpret_cast<const char*>(0x8363AC))); // special index
		return 0x4E3686;
	}
	...
	{
		//obsi.pcx
		R->EAX(PCXImages::Instance->GetSurface(reinterpret_cast<const char*>(0x836334))); // special index
		return 0x4E3686;
	}
...
ASMJIT_PATCH(0x4F8C97, HouseClass_AI_BuildConst, 6)
{
	...
	HouseExtData::SetFirestormState(pThis, false);
