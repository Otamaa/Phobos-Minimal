...
ASMJIT_PATCH(0x6B7793, SpawnManagerClass_Update_RecycleSpawned, 0x7)
{
	...
	auto const pCarrierTypeExt = GET_TECHNOTYPEEXT(pCarrier);
...
DEFINE_FUNCTION_JUMP(LJMP, 0x707E60, FakeTechnoClass::__GetGuardRange);
DEFINE_FUNCTION_JUMP(VTABLE, 0x7E25C0, FakeTechnoClass::__GetGuardRange);
DEFINE_FUNCTION_JUMP(VTABLE, 0x7E41D8, FakeTechnoClass::__GetGuardRange);
DEFINE_FUNCTION_JUMP(VTABLE, 0x7E8FB0, FakeTechnoClass::__GetGuardRange);
...
//
// 	return R->Origin() + 0x6;
// }ASMJIT_PATCH_AGAIN(0x73D515, UnitClass_Harvesting_HarvesterLoadRate, 6)

ASMJIT_PATCH(0x73E951, UnitClass_MI_Harvest_HarvesterLoadRate, 6)
{
