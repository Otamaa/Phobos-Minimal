 ...
 *
 * ```c
 * #include <Lib/SDL3/SDL.h>
 * #include <Lib/SDL3/SDL_main.h>
 *
...
#include <Lib/SDL3/SDL_platform_defines.h>
...
#define SDL_MAIN_NEEDED
        ...
        */
        ...
        /* On iOS and tvOS SDL provides a main function that creates an application delegate and starts the application run loop.
           ...
           To use it, just #include <Lib/SDL3/SDL_main.h> in the source file that contains your main() function.
...
#include <Lib/SDL3/SDL_begin_code.h>
#ifdef __cplusplus
extern "C" {
#endif
