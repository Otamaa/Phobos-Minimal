...
DEFINE_PIGGYLOCO(Attachment,C5D54B98-8C98-4275-8CE4-EF75CB0CBE3E)
{
public:
	...
	virtual Matrix3D* __stdcall Draw_Matrix(Matrix3D* pMatrix, VoxelIndexKey* key) override;
	...
	virtual VisualType __stdcall Visual_Character(VARIANT_BOOL raw) override;
