...
DEFINE_HOOK(0x422FCC, AnimClass_Draw_Details, 5)
{
	const auto details = RulesExtData::DetailsCurrentlyEnabled();
	return details ? 0x422FECu : 0x422FD9u;
}

DEFINE_HOOK(0x550BCA, LaserDrawClass_Draw_InHouseColor_Details, 5)
{
	const auto details = RulesExtData::DetailsCurrentlyEnabled();
	return details ? 0x550BD7u : 0x550BE5u;
}

DEFINE_HOOK(0x62CEC9, ParticleClass_Draw_Details, 5)
{
	const auto details = RulesExtData::DetailsCurrentlyEnabled();
	return details ? 0x62CEEAu : 0x62CED6u;
}

DEFINE_HOOK(0x6D7847, TacticalClass_DrawPixelEffects_Details, 5)
{
	const auto details = RulesExtData::DetailsCurrentlyEnabled();
	return details ? 0x6D7858u : 0x6D7BF2u;
}

DEFINE_HOOK(0x420F40, AlphaShapeClass_DrawAll_Details, 6)
{
	const auto details = RulesExtData::DetailsCurrentlyEnabled();
