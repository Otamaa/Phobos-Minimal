...
public:
	...
	ValueableVector<TechnoTypeClass*> AffectTypes; // 可影响的单位
	ValueableVector<TechnoTypeClass*> NotAffectTypes; // 不可影响的单位
...
private:
	...
	void Serialize(T& Stm)
	{
		...
		AnimationTypeData.Serialize(Stm);
		AttachStatusTypeData.Serialize(Stm);
