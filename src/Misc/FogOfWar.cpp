...
ASMJIT_PATCH(0x5F4B3E, ObjectClass_DrawIfVisible, 0x6)
{
...
ASMJIT_PATCH(0x6F5190, TechnoClass_DrawExtras_CheckFog, 0x6)
{
...
ASMJIT_PATCH(0x6D6EDA, TacticalClass_Overlay_CheckFog1, 0xA)
{
...
ASMJIT_PATCH(0x71CC8C, TerrainClass_DrawIfVisible, 0x6)
{
...
ASMJIT_PATCH(0x4804A4, CellClass_DrawTile_DrawSmudgeIfVisible, 0x6)
{
...
ASMJIT_PATCH(0x4ACE3C, MapClass_TryReshroudCell_SetCopyFlag, 0x6)
{
	GET(CellClass*, pCell, EAX);
...
ASMJIT_PATCH(0x70076E, TechnoClass_GetCursorOverCell_OverFog, 0x5)
{
	GET(CellClass*, pCell, EBP);
	auto const pExt = CellExtContainer::Instance.Find(pCell);
	...
	if (nOvlIdx != -1)
		R->Stack<OverlayTypeClass*>(STACK_OFFS(0x2C, 0x18), OverlayTypeClass::Array->Items[nOvlIdx]);

	return 0x700815;
}

ASMJIT_PATCH(0x6D3470, TacticalClass_DrawFoggedObject, 0x8)
{
...
ASMJIT_PATCH(0x51F95F, InfantryClass_GetCursorOverCell_OverFog, 0x6)
{
...
ASMJIT_PATCH(0x4ADFF0, MapClass_RevealMapShroud, 0x5)
{
...
ASMJIT_PATCH(0x577EBF, MapClass_Reveal, 0x6)
{
	GET(CellClass*, pCell, EAX);
...
ASMJIT_PATCH(0x586683, CellClass_DiscoverTechno, 0x5)
{
...
ASMJIT_PATCH(0x4FC1FF, HouseClass_PlayerDefeated_MapReveal, 0x6)
{
