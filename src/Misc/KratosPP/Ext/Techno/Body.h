...
#include <Misc/KratosPP/Utils/GoExtension.h>
#include <TechnoClass.h>
#include <Misc/KratosPP/Events/EventSystem.h>

class TechnoExtData : public GOExtensionData<TechnoClass, TechnoExtData>
{
public:
	 ...
	 * @param ext ExtData
	 */
	static void AddGlobalScripts(std::list<std::string>& globalScripts, IExtData* ext);
