...
extern "C" IDirect3D9 *WINAPI Direct3DCreate9On12(UINT SDKVersion, D3D9ON12_ARGS *pOverrideList, UINT NumOverrideEntries) // Export ordinal 20
{
	...
	Debug::Log("Redirecting Direct3DCreate9On12(SDKVersion = %u, pOverrideList = %p, NumOverrideEntries = %u) ...",
	...
	if (res == nullptr)
	{
		Debug::Log("Direct3DCreate9On12 failed.");
		return nullptr;
	}
...
extern "C"     HRESULT WINAPI Direct3DCreate9On12Ex(UINT SDKVersion, D3D9ON12_ARGS *pOverrideList, UINT NumOverrideEntries, IDirect3D9Ex **ppOutputInterface) // Export ordinal 21
{
	...
	Debug::Log("Redirecting Direct3DCreate9On12Ex(SDKVersion = %u, pOverrideList = %p, NumOverrideEntries = %u, ppOutputInterface = %p) ...",
	...
	if (FAILED(hr))
	{
		Debug::Log("Direct3DCreate9On12Ex failed with error code %s.", Debug::hr_to_string(hr).c_str());
		return hr;
	}
