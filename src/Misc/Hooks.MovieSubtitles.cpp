...
ASMJIT_PATCH(0x432FBC, MoviePlayer_BinkCopyToBuffer_Flags, 0xA)
{
...
ASMJIT_PATCH(0x433320, MoviePlayer_DrawSubtitles_Background, 0x6)
{
	...
	if (Phobos::UI::MovieSubtitles_Background && pSurface && pDestRect && pDestRect->Width > 0 && pDestRect->Height > 0)
	{
		...
		pSurface->Fill_Rect_Trans(&bgRect, &Phobos::UI::MovieSubtitles_BackgroundColor, Phobos::UI::MovieSubtitles_BackgroundOpacity);
	}
...
ASMJIT_PATCH(0x4333C9, MoviePlayer_ClearSubtitles_Padding, 0x6)
{
