...
#include <Misc/Kratos/Ext/Helper/DrawEx.h>
...
#include <Misc/Kratos/Ext/Helper/SurfaceEx.h>
...
#include <Misc/Kratos/Ext/EffectType/Effect/AttackBeaconEffect.h>
#include <Misc/Kratos/Ext/EffectType/Effect/CounterEffect.h>
#include <Misc/Kratos/Ext/EffectType/Effect/StandEffect.h>
#include <Misc/Kratos/Ext/BulletType/BulletStatus.h>
#include <Misc/Kratos/Ext/TechnoType/TechnoStatus.h>
#include <Misc/Kratos/Ext/TechnoType/UploadAttachData.h>
#include <Misc/Kratos/Ext/WeaponType/FeedbackAttachData.h>

#include <Misc/Kratos/Ext/StateType/State/AntiBulletData.h>
#include <Misc/Kratos/Ext/StateType/State/DestroyAnimData.h>
#include <Misc/Kratos/Ext/StateType/State/DestroySelfData.h>
#include <Misc/Kratos/Ext/StateType/State/GiftBoxData.h>
#include <Misc/Kratos/Ext/StateType/State/PaintballData.h>
#include <Misc/Kratos/Ext/StateType/State/TeleportData.h>
#include <Misc/Kratos/Ext/StateType/State/TransformData.h>
...
void AttachEffect::AttachUploadAE()
{
	...
	if (pTechno->Passengers.NumPassengers > 0)
	{
		...
		do
		{
			CheckAndAttachUploadAE(flag_cast_to<TechnoClass*>(pPassenger));
		...
		if (Common::DebugAE)
		{
			...
			if (_gameObject)
			{
				...
				for (Component::ComponentInfo& info : infos)
				{
					...
					log.append("\n");
					pos.Y += offsetZ;
					ColorStruct color = ColorStruct::Green;
					if (!info.Active)
					{
						color = ColorStruct::Red;
					}
			...
			for (auto it = AEStacks.begin(); it != AEStacks.end(); it++)
			{
				...
				pos2.Y -= offsetZ;
				PrintTextManager::PrintText(log, ColorStruct::Red, pos2);
			}
		}
#endif // DEBUG
	}
...
void AttachEffect::OnUpdate()
{
	...
	if (!_ownerIsDead)
	{
		...
		if (!IsBullet())
		{
			...
			{
				// 关闭当前建筑电源
				PowerOff = !cast_to<BuildingClass*, true>(pTechno)->HasPower;
			}
		}
