...
BulletClass* FireBulletTo(ObjectClass* pShooter, TechnoClass* pAttacker, AbstractClass* pTarget, HouseClass* pAttacingHouse,
	WeaponTypeClass* pWeapon, CoordStruct sourcePos, CoordStruct targetPos, VelocityClass velocity = VelocityClass::Empty, CoordStruct flh = CoordStruct::Empty, bool isOnTurret = true);
...
BulletClass* FireBullet(TechnoClass* pAttacker, AbstractClass* pTarget, HouseClass* pAttacingHouse,
	...
	CoordStruct sourcePos = CoordStruct::Empty, CoordStruct targetPos = CoordStruct::Empty, VelocityClass velocity = VelocityClass::Empty);
