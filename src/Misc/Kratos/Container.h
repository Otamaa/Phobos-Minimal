...
public:
	explicit KratosContainer(const char* pName) :
		Items(),
	...
	virtual ~KratosContainer() = default;
...
private:
	KratosContainer(const KratosContainer&) = delete;
	KratosContainer& operator = (const KratosContainer&) = delete;
	KratosContainer& operator = (KratosContainer&&) = delete;
};
