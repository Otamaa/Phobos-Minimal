...
ASMJIT_PATCH(0x67CEF0, SaveGame_Start, 0x6)
{
...
ASMJIT_PATCH(0x67D2F1, SaveGame_End, 0x6)
{
...
ASMJIT_PATCH(0x67D300, SaveGameInStream_Start, 0x5)
{
...
ASMJIT_PATCH(0x67E42E, SaveGameInStream_End, 0xD)
{
...
ASMJIT_PATCH(0x67E440, LoadGame_Start, 0x6)
{
	GET(const char *, fileName, ECX);
...
ASMJIT_PATCH(0x67E720, LoadGame_End, 0x6)
{
