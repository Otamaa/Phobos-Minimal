...
#include <Misc/Kratos/Extension/VoxelAnimTypeExt.h>
...
ASMJIT_PATCH(0x74BA31, VoxelAnimTypeClass_DTOR, 0x5)
{
...
ASMJIT_PATCH(0x74B8D0, VoxelAnimTypeClass_SaveLoad_Prefix, 0x8)
{
...
ASMJIT_PATCH(0x74B8C2, VoxelAnimTypeClass_Load_Suffix, 0x5)
{
	VoxelAnimTypeExt::ExtMap.LoadStatic();
	return 0;
}

ASMJIT_PATCH(0x74B8EA, VoxelAnimTypeClass_Save_Suffix, 0x5)
{
