...
//
//ASMJIT_PATCH(0x52BA60, YR_Boot, 0x5)
//{
//	return 0;
//}

ASMJIT_PATCH(0x52F639, YR_CmdLineParse, 0x5)
{
	GET(char **, ppArgs, ESI);
...
ASMJIT_PATCH(0x7CD810, ExeRun, 0x9)
{
...
{
	KratosCommon::IsScenarioClear = true;
	return 0;
}
...
ASMJIT_PATCH(0x6875F3, Scenario_Start1, 0x6)
{
...
ASMJIT_PATCH(0x55AFB3, LogicClass_Update, 0x6)
{
