...
ASMJIT_PATCH(0x6CE800, SuperWeaponTypeClass_SaveLoad_Prefix, 0xA)
{
...
ASMJIT_PATCH(0x6CE8BE, SuperWeaponTypeClass_Load_Suffix, 0x7)
{
	SuperWeaponTypeExt::ExtMap.LoadStatic();
	return 0;
}

ASMJIT_PATCH(0x6CE8EA, SuperWeaponTypeClass_Save_Suffix, 0x3)
{
