...
#include <Misc/Kratos/Container.h>
#include <Misc/Kratos/Common/Components/Component.h>
#include <Misc/Kratos/Common/Components/GameObject.h>
...
#pragma endregion
	...
	class ExtContainer : public KratosContainer<TExt>
	{
	public:
		ExtContainer() : KratosContainer<TExt>(typeid(TExt).name()) { }
