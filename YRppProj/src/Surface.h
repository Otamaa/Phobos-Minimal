...
bool __fastcall Buffer_To_RLE_Surface_With_Z_Shape(Surface *surface1, Point2D *point1, RectangleStruct *rect1, Surface *surface2, Point2D *point2, RectangleStruct *rect2, void* blitter, int height_offset, int somearrayindex, int a10, int arg_20, Surface *z_shape_surface, int shape_x_offset, int shape_y_offset, int useotherblitterset)
;// { JMP_STD(0x437A10); }

bool __fastcall Buffer_To_Surface_with_LastArg(Surface *tosurface, RectangleStruct *rect1, RectangleStruct *torect, Surface *fromsurface, RectangleStruct *a5, RectangleStruct *fromrect, void* blitter, int z_val, int somearrayindex, int alpha_val, int use_new_blitter, int wrap_value)
;// { JMP_STD(0x4373B0); }

bool __fastcall Surface_To_Buffer(Surface& surface, RectangleStruct& rect, MemoryBuffer& buffer)
;// { JMP_STD(0x4371D0); }

bool __fastcall Buffer_To_Surface(Surface& surface, RectangleStruct& rect, MemoryBuffer& buffer)
;// { JMP_STD(0x437290); }
...
// Used for linetrail
bool __fastcall Surface_4BEAC0_Blit(Surface* Surface, RectangleStruct& nRect, Point2D& nPoint1, Point2D& nPoint2, int& nSomeval, unsigned nSomeval2, int nAdjust_1, int nAdjust2)
;// { JMP_STD(0x4BEAC0); }

RectangleStruct* __fastcall GetTextBox(RectangleStruct* pRet, char* text, int xpos, int ypos, TextPrintType flag, int x_offset, int y_offset)
;// { JMP_STD(0x4A59E0); }

// Comments from thomassneddon
void __fastcall CC_Draw_Shape(Surface* Surface, ConvertClass* Palette, SHPStruct* SHP, int FrameIndex,
...
Point2D* Fancy_Text_Print_Wide(Point2D* RetVal, const wchar_t* Text, Surface* Surface, RectangleStruct* Bounds,
	Point2D* Location, unsigned int ForeColor, unsigned int BackColor, TextPrintType Flag, ...)
	;// { JMP_STD(0x4A60E0); }

Point2D* Fancy_Text_Print_Wide_REF(Point2D* RetVal, const wchar_t* Text, Surface* Surface, RectangleStruct* Bounds,
	Point2D* Location, COLORREF ForeColor, COLORREF BackColor, TextPrintType Flag, ...)
	;// { JMP_STD(0x4A60E0); }

Point2D* Fancy_Text_Print_Wide(const Point2D& retBuffer, const wchar_t* Text, Surface* Surface, const RectangleStruct& Bounds,
...
//
Point2D* __fastcall Simple_Text_Print_Wide(Point2D* RetVal, const wchar_t* Text, Surface* Surface, RectangleStruct* Bounds,
...
bool __fastcall Buffer_To_Surface_wrapper(Surface *tosurface, RectangleStruct *torect, Surface *fromsurface, RectangleStruct *fromrect)
;// { JMP_STD(0x7BC1F0); }

bool __fastcall Buffer_To_Surface_wrapper(Surface *tosurface, RectangleStruct *torect, Surface *fromsurface, RectangleStruct *fromrect, void* blitter, int z_val, int somearrayindex, int alpha_val, int Blit_Move_2_arg)
;// { JMP_STD(0x437350); }

bool __fastcall Blit_helper_lockregion(Surface* dst_surf, RectangleStruct* rect1, RectangleStruct* rect2, Surface* src_surf, RectangleStruct* rect3, RectangleStruct* rect4, bool* checkme, __int16* dst_buffer, __int16* src_buffer)
;// { JMP_STD(0x7BC040) }
