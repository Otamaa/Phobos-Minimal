...
struct ConstructableWeaponStruct
{
	...
	constexpr ConstructableWeaponStruct() = default;

	constexpr ConstructableWeaponStruct(WeaponTypeClass* pWeapon ,CoordStruct nFLH , int nBarrelLength , int bBarrelThickness ,bool bTurrentLocked)
		: WeaponType { pWeapon }
		, FLH { nFLH }
...
struct ConstructableVoxelStruct
{
	...
	constexpr bool operator == (const ConstructableVoxelStruct& nOther) const
	{ return false; } // ?
};
...
struct ConstructableTurretControl
{
	...
	constexpr bool operator == (const ConstructableTurretControl& nOther) const
	{
...
struct DamageGroup
{
	...
	constexpr bool operator == (const DamageGroup& nOther) const {
