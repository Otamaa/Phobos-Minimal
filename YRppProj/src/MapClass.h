...
{
	constexpr bool operator==(const CrackedIceStruct& src) const { return false; }
	constexpr bool operator!=(const CrackedIceStruct& src) const { return true; }
...
struct ZoneConnectionClass
{
	...
	constexpr bool operator==(const ZoneConnectionClass &other) const {
...
struct SubzoneConnectionStruct
{
	...
	//need to define a == operator so it can be used in array classes
	constexpr bool operator==(const SubzoneConnectionStruct &other) const {
...
struct SubzoneTrackingStruct
{
	...
	//need to define a == operator so it can be used in array classes
	constexpr bool operator==(const SubzoneTrackingStruct &other) const {
