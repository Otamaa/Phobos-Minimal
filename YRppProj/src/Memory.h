...
void* __cdecl __mh_malloc(size_t size, int flag);

void __cdecl __free(void* mem);

// the game's operator new
void* __cdecl Allocate(size_t sz);

// C Alloc
void* __cdecl MAllocate(size_t sz);

// the game's operator delete
void __cdecl Deallocate(const void* mem);
