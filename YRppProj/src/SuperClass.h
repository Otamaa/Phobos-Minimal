...
public:
	...
	static void Start(int duration, int deferment, CellStruct cell, HouseClass* pOwner)
		;//{ PUSH_VAR32(pOwner); PUSH_VAR32(cell); SET_REG32(EDX, deferment); SET_REG32(ECX, duration); ASM_CALL(0x539EB0); }
...
public:
	...
	static void Start(HouseClass* pOwner, CellStruct coords)
		;//{ PUSH_VAR32(coords); SET_REG32(ECX, pOwner); ASM_CALL(0x53AE50); }
...
public:
	...
	static void Start(int duration)
		;//{ SET_REG32(ECX, duration); ASM_CALL(0x53B460); }
