...
public:
	constexpr bool operator==(const SwizzlePointerClass& tOther) const
		{
		return
	...
	constexpr bool operator!=(const SwizzlePointerClass& that) const { return unknown_0 != that.unknown_0; }
	constexpr bool operator<(const SwizzlePointerClass& that) const { return unknown_0 < that.unknown_0; }
	constexpr bool operator>(const SwizzlePointerClass& that) const { return unknown_0 > that.unknown_0; }
};
