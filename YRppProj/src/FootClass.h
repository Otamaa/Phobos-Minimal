...
public:
	...
	CDTimerClass PathDelayTimer; //CDTimerClass
	int             TryTryAgain; //64C
	CDTimerClass unknown_timer_650; //BaseAttackTimer  CDTimerClass
	CDTimerClass SightTimer;
	CDTimerClass BlockagePathTimer;
	ILocomotionPtr Locomotor;
	...
	CDTimerClass ParalysisTimer; // for squid victims
