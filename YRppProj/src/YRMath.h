...
#define MATH_FUNC(ret ,arg ,name) ret __cdecl name(arg value);
#define MATH_FUNC_TWOVAL(name) float __cdecl name(double valuea , double valueb);
#define MATH_FUNC_FLOAT(ret , arg , name) ret __stdcall name(arg value);
#define MATH_FUNC_TWOVAL_FLOAT(name) double __stdcall name(float valuea , float valueb);
...
namespace Math
{
	...
	MATH_FUNC(float, double, sqrt);
	MATH_FUNC(float, double, sin);
	MATH_FUNC(float, double, cos);

	MATH_FUNC(double, double, tan);
	MATH_FUNC(double, double, asin);
	MATH_FUNC(double, double, acos);
	MATH_FUNC(double, double, atan);

	MATH_FUNC_TWOVAL(atan2);
	MATH_FUNC_TWOVAL(arctanfoo);

	MATH_FUNC_FLOAT(float, float, sqrt);
	MATH_FUNC_FLOAT(double, float, sin);
	MATH_FUNC_FLOAT(double, float, cos);
	MATH_FUNC_FLOAT(double, float, asin);
	MATH_FUNC_FLOAT(double, float, tan);

	MATH_FUNC_FLOAT(double, float, acos);
	MATH_FUNC_FLOAT(double, float, atan);
	MATH_FUNC_TWOVAL_FLOAT(atan2);
