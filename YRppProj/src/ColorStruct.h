...
struct BytePalette
{
	...
	BytePalette& operator=(const BytePalette& that);// { JMP_THIS(0x6260D0); }

	void Adjust(int ratio);// { JMP_THIS(0x6260F0); }

	void Adjust(int ratio, const BytePalette& palette);//  { JMP_THIS(0x626120) }

	void Partial_Adjust(int ratio, char* palette);//  {	JMP_THIS(0x626170); }

	void Partial_Adjust(int ratio, const BytePalette& palette, char* lut);// {	JMP_THIS(0x6261B0);	}

	int Closest_Color(ColorStruct& rgb) const;// {	JMP_THIS(0x626200);	}
