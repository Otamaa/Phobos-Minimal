...
public:
	...
	bool IsFactory() const;// { JMP_THIS(0x455DA0); }

	void DestroyExtrasFunctions(AbstractClass* pKiller) const;//  {	JMP_THIS(0x442D90);	}

	int GetRadiuses_4566B0() const;//  { JMP_THIS(0x4566B0); }

	InfantryTypeClass* GetBuildingCrewType() const;//  { JMP_THIS(0x44EB10); }

	void Infiltrate(HouseClass* ByWho) const;//  { JMP_THIS(0x4571E0); }

	bool Undeployable() const;//  { JMP_THIS(0x449BC0); }

	void UpdateAnimations() const;//  { JMP_THIS(0x4509D0); }

	void UpdatePowerDown() const;// { JMP_THIS(0x4549B0); }
	...
	void KickAllOccupants(bool missionHunt, bool donotKill) const;// {	JMP_THIS(0x457DE0);	}
