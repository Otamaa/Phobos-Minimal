...
void InfantryClass::RemoveMe_FromGunnerTransport()
{
	...
	{
		if (pTransport->WhatAmI() == UnitClass::AbsID)
		{
			auto pUnit = static_cast<UnitClass*>(pTransport);
...
void TechnoClass::FreeSpecificSlave(HouseClass* Affector)
{
	...
	if (this->WhatAmI() == InfantryClass::AbsID)
	{
		auto pSlave = static_cast<InfantryClass*>(this);
