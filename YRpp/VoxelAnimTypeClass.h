...
public:
	...
	static COMPILETIMEEVAL OPTIONALINLINE DWORD vtable = 0x7F6548;

	//Array
	static COMPILETIMEEVAL constant_ptr<DynamicVectorClass<VoxelAnimTypeClass*>, 0xA8EB28u> const Array {};
