...
public:
	...
	//AbstractClass
	virtual void PointerExpired(AbstractClass* pAbstract, bool bremoved) override { JMP_THIS(0x41B660); }
	...
	virtual bool Unlimbo(const CoordStruct& Crd, DirType dFaceDir) override JMP_THIS(0x414310);
