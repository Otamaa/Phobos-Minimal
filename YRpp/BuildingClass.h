...
public:
	...
	virtual DirStruct FireAngleTo(AbstractClass* pObject) const JMP_THIS(0x43ED40);
	//first argument are never used so re-used
	virtual void Destroy(WarheadTypeClass* pWH, TechnoClass* pTechno, bool NoSurvivor, const CellStruct* foundation) JMP_THIS(0x4415F0);
