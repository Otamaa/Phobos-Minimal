...
public:
	...
	static COMPILETIMEEVAL OPTIONALINLINE DWORD vtable = 0x7F522C;

	//global array
	static COMPILETIMEEVAL constant_ptr<DynamicVectorClass<TerrainClass*>, 0xA8E988u> const Array{};

	//IPersist
	virtual HRESULT __stdcall GetClassID(CLSID* pClassID) R0;

	//IPersistStream
	virtual HRESULT __stdcall Load(IStream* pStm) JMP_STD(0x71CDA0);
	virtual HRESULT __stdcall Save(IStream* pStm, BOOL fClearDirty) JMP_STD(0x71CF30);
	...
	virtual void PointerExpired(AbstractClass* pAbstract, bool bremoved) override JMP_THIS(0x71CFD0);
	...
	virtual bool Mark(MarkType value) override { JMP_THIS(0x71BFB0); }
