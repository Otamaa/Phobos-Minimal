...
ObjectClass* Attacker, bool IgnoreDefenses, bool PreventPassengerEscape, HouseClass* pAttackingHouse) override JMP_THIS(0x701900);
	...
	virtual bool EnterIdleMode(bool Initial, int nUnknown) JMP_THIS(0x4D82B0);//virtual bool vt_entry_484(DWORD dwUnk, DWORD dwUnk2) R0;
	...
	//non-virtual
	bool IsNearBridge() const { JMP_THIS(0x703B10); }
...
static_assert(offsetof(TechnoClass, BarrelFacing) == 0x370, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, PrimaryFacing) == 0x388, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, SecondaryFacing) == 0x3A0, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, CurrentBurstIndex) == 0x3B8, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, TargetLaserTimer) == 0x3BC, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, __shipsink_3CA) == 0x3CA, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, weapon_sound_randomnumber_3C8) == 0x3C8, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, CountedAsOwned) == 0x3CC, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, IsSinking) == 0x3CD, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, WasSinkingAlready) == 0x3CE, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, __ProtectMe_3CF) == 0x3CF, "ClassMember Shifted !");
static_assert(offsetof(TechnoClass, IsPrimaryFactory) == 0x3D3, "ClassMember Shifted !");
