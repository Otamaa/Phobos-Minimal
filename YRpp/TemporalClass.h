...
public:
	...
	static COMPILETIMEEVAL OPTIONALINLINE DWORD vtable = 0x7F5180;

	//Static
	static COMPILETIMEEVAL constant_ptr<DynamicVectorClass<TemporalClass*>, 0xB0EC60u> const Array{};
	...
	//Destructor
	virtual ~TemporalClass() override JMP_THIS(0x71A5D0);
