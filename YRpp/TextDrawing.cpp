...
Point2D TextDrawing::Simple_Text_Print_Wide(
	BitFont* pFont,
	const wchar_t* text,
	Surface* surface,
...
Point2D TextDrawing::Plain_Text_Print_Wide(
const wchar_t* text,
Surface* surface,
RectangleStruct* rect,
Point2D* xy,
...
Point2D TextDrawing::Fancy_Text_Print_Wide_NoFormat(const wchar_t* Text, Surface* Surface, RectangleStruct* Bounds,
