...
public:
	...
	//Static
	static COMPILETIMEEVAL constant_ptr<DynamicVectorClass<InfantryClass*>, 0xA83DE8u> const Array{};
	static COMPILETIMEEVAL OPTIONALINLINE DWORD vtable = 0x7EB058;
	...
	//AbstractClass
	virtual void PointerExpired(AbstractClass* pAbstract, bool bremoved) override { JMP_THIS(0x51AA10); }
	...
	virtual CoordStruct GetFLH(int idxWeapon, int BaseCoordsX , int BaseCoordsY , int BaseCoordsZ) const override { JMP_THIS(0x523250); }
