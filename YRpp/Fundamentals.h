...
namespace Unsorted
{
	static constexpr int DefaultDockDir = 0x4000;
	...
	static  constexpr int LevelHeight = 104;
	// tan(deg2rad(90) - deg2rad(60)) * sqrt(2 * 256 ^ 2) * 0.5
	// cot(deg2rad(30)) * diagonal_leptons_per_cell * 0.5
	// sqrt(3)/3 * 362.038 * 0.5

	// Leptons per cell.
	static  constexpr int LeptonsPerCell = 256;
	static  constexpr double d_LeptonsPerCell = 256.0;

	// Cell width in pixels.
	static constexpr int CellWidthInPixels = 60;

	// Cell height in pixels.
	static  constexpr int CellHeightInPixels = 30;
