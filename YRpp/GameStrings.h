...
struct GameStrings
{
	...
	GAMEMD_STR(GAME_FNT, 0x818B98u);
	GAMEMD_STR(SAVEGAME_NET, 0x820DACu);
	...
	// EVA entry names
	GAMEMD_STR(EVA_UnitRepaired, 0x81905C);
	...
	GAMEMD_STR(EVA_OurBaseIsUnderAttack, 0x824768u);
	GAMEMD_STR(EVA_OurAllyIsUnderAttack, 0x82474Cu);
