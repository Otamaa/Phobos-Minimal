...
public:
	...
	//IPersistStream
	virtual HRESULT __stdcall Load(IStream* pStm) override JMP_THIS(0x6E86A0);
	virtual HRESULT __stdcall Save(IStream* pStm, BOOL fClearDirty) override JMP_THIS(0x6E8680);
